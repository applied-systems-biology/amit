...
namespace ibp
{
    ...
    cv::Mat segSplitFull(const cv::Mat &src, const cv::Mat &sd1, const cv::Mat &sd2, const std::string &rmg, const std::string &FFT_MASK_PATH, const bool &clear_border, const int &min_region_size, const std::string &OUTPUTDIR_CNT, const int &i, const bool &FLAG_DEBUG);
